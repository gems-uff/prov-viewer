...
//    private int id;
    ...
    /**
     * Method to check if the edge is a collapsed edge (new edge that contains the information of the collapsed ones)
    ...
    /**
     * Method for returning the edge's influence value (edge.influence = value + type)
    ...
    /**
     * Method to check if the edge is of the neutral type (Empty influence or value equals zero
    ...
    /**
     * Method to get the edge's color (red, black, or green), definied by the influence's value
     * @return 
     */
